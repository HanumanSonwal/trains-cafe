        ...
        <Card className="shadow-lg overflow-hidden">
          ...
          <div className="text-center mb-4 sm:mb-6">
            <div className="flex justify-center mb-2 sm:mb-3">
              <CheckCircleFilled className="text-3xl text-[#704d25] animate-bounce" />
            </div>
          ...
          <Card className="mb-4 sm:mb-6 bg-gray-50">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <div className="space-y-1">
                ...
                <div className="font-medium text-sm">{new Date(orderData.createdAt).toLocaleDateString()}</div>
              </div>
              <div className="space-y-1">
                <Text type="secondary" className="text-sm">Order ID</Text>
                <div className="font-medium text-sm break-all">{orderData.order_id}</div>
              </div>
          ...
          {/* Train Details */}
          <Card className="mb-4 sm:mb-6 bg-gray-50">
            <Title level={4} className="!text-lg sm:!text-xl mb-3 sm:mb-4">Train Details</Title>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="space-y-1">
                <Text type="secondary" className="text-sm">Train Number</Text>
                <div className="font-medium text-sm">{orderData.train?.train_number}</div>
              </div>
              <div className="space-y-1">
                <Text type="secondary" className="text-sm">Train PNR</Text>
                <div className="font-medium text-sm">{orderData.train?.train_pnr}</div>
              </div>
            </div>
          </Card>
          ...
          <Card className="mb-4 sm:mb-6 bg-gray-50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="space-y-1">
                ...
                <div className="font-medium text-sm">{orderData.user_details.coach}</div>
              </div>
              <div className="space-y-1">
          ...
          {orderData.user_details?.instructions && (
            <Card className="mb-4 sm:mb-6 bg-gray-50">
              <Title level={4} className="!text-lg sm:!text-xl mb-3 sm:mb-4">Special Instructions</Title>
              <Text className="text-sm">{orderData.user_details.instructions}</Text>
            </Card>
          )}

          {/* Order Status */}
          <Card className="mb-4 sm:mb-6 bg-gray-50">
            <Title level={4} className="!text-lg sm:!text-xl mb-3 sm:mb-4">Order Status</Title>
            <Text className="text-sm font-medium capitalize">{orderData.status}</Text>
          </Card>
