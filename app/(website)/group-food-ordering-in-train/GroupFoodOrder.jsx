          ...
          <div className=" mb-8">
            ...
            <div className="py-2">
              ...
              <p>
                ...
                is delivered. <br></br>
                <br></br> Making a reservation for a large meal on a train is
                not the same as ordering takeout. The restaurants must prepare
                more food for bulk orders because they are intended for larger
                groups of patrons, which takes more time. Furthermore,
                ...
                train. <br></br> <br></br>Therefore, if you intend to get a
                large quantity of food for your train ride, be sure to schedule
                your order well in advance. This will guarantee that the meal
                you order is delivered on schedule and that it is what you
                desire. <b>Order food on train</b>, contact us at{" "}
                <Link
                  href="tel:+918696963496"
                  className="font-bold text-blue-600 hover:text-blue-800 underline"
                >
              ...
              <h4 className="font-bold text-[#704d25]">
                How to do Group Food Ordering in Train
              </h4>
              <p>
            ...
            <p>
              <b> Group food ordering in train</b> has undoubtedly
              revolutionized the dining experience during train journeys,
              offering passengers unparalleled convenience, variety, and
              efficiency. So, the next time you embark on a train journey with
              friends or family, consider harnessing the power of group food
              ordering for a truly enjoyable dining experience on the rails.
            </p>
            <h2
              className="my-2"
              style={{
            ...
            <div>
              <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
                <li style={{ marginBottom: "14px", fontSize: "14px" }}>
                  <strong>Q1:</strong>{" "}
                  <strong>How can I order Group food in train?</strong>
                  <br />
                  <strong>Ans.</strong> You can order group food in train simply
                  by calling us on{" "}
                  <Link
                    href="tel:+918696963496"
                    className="font-bold text-blue-600 hover:text-blue-800 underline"
                ...
                <li style={{ marginBottom: "14px", fontSize: "14px" }}>
                  <strong>Q2:</strong>{" "}
                  <strong>
                    Is COD available for Group food ordering in train?
                  </strong>
                  <br />
                ...
                <li style={{ marginBottom: "14px", fontSize: "14px" }}>
                  <strong>Q3:</strong>{" "}
                  <strong>
                    Can we order group food in train from multiple resturants ?
                  </strong>
                  <br />
                ...
                <li style={{ marginBottom: "14px", fontSize: "14px" }}>
                  <strong>Q4:</strong>{" "}
                  <strong>
                    What is the minimum order we can do for group food in train?
                  </strong>
                  <br />
