      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 430px) {
          .page { padding: 1rem 1rem 2rem; justify-content: flex-start; padding-top: 3rem; }

          .railway-border { inset: 8px; }
          .corner { width: 24px; height: 24px; }
          .corner-tl, .corner-tr { top: 4px; }
          .corner-bl, .corner-br { bottom: 4px; }
          .corner-tl, .corner-bl { left: 4px; }
          .corner-tr, .corner-br { right: 4px; }

          .logo-mark { font-size: 0.65rem; letter-spacing: 0.2em; margin-bottom: 1.5rem; }
          .eyebrow { font-size: 0.55rem; letter-spacing: 0.2em; margin-bottom: 1.2rem; gap: 0.6rem; }
          .eyebrow::before, .eyebrow::after { width: 28px; }

          .train-scene { width: 100%; max-width: 240px; height: 100px; margin-bottom: 1.5rem; }
          .train { left: 10px; }
          .boiler { width: 72px; height: 34px; border-radius: 17px 6px 6px 17px; }
          .cab { width: 38px; height: 40px; }
          .cab-window { width: 13px; height: 10px; top: 7px; left: 6px; }
          .chimney { width: 10px; height: 16px; top: -13px; left: 12px; }
          .chimney::before { width: 14px; height: 4px; top: -3px; left: -2px; }
          .wheel-lg { width: 22px; height: 22px; bottom: -4px; }
          .w1 { left: 10px; }
          .w2 { left: 38px; }
          .w3 { left: 66px; }
          .wheel-sm { width: 15px; height: 15px; }
          .ws1 { left: 4px; bottom: -1px; }
          .cup { width: 24px; height: 20px; right: -28px; bottom: 7px; }
          .smoke-container { top: -40px; left: 20px; }
          ...
          .description { font-size: 0.88rem; line-height: 1.7; margin-bottom: 1.8rem; padding: 0 0.2rem; }

          .progress-section { margin-bottom: 1.8rem; }
          .progress-label { font-size: 0.65rem; }
          .progress-label strong { font-size: 0.9rem; }

          .info-grid { grid-template-columns: 1fr 1fr; gap: 0.6rem; margin-bottom: 1.8rem; }
          .info-tile { padding: 0.7rem 0.8rem; }
          .tile-label { font-size: 0.55rem; letter-spacing: 0.15em; }
          .tile-value { font-size: 0.88rem; }

          .contact-line { font-size: 0.68rem; letter-spacing: 0.06em; padding-top: 1.2rem; }
        }

        @media (max-width: 320px) {
          .headline { font-size: 2rem; }
          .info-grid { grid-template-columns: 1fr; }
          .train-scene { max-width: 200px; }
        }
      `}</style>
