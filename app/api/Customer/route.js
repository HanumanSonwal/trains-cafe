...
export async function POST(req) {
    try {
        ...
        if (!body.Customer_Name || !body.Mobile_Number || !body.Email || !body.PNR || !body.Coach || !body.Discount || !body.Seat_No ) {
        ...
        return new Response(JSON.stringify({ success: true, message: 'Customer added successfully', data: newcustomer }), { status: 201 });
    } catch (error) {
...
export async function PUT(req) {
    try {
        ...
        if (!id) {
            return new Response(JSON.stringify({ success: false, message: 'Customer ID is required' }), { status: 400 });
        }
        ...
        return new Response(JSON.stringify({ success: true, message: 'Customer updated successfully', data: updatedcustomer }), { status: 200 });
    } catch (error) {
        return new Response(JSON.stringify({ success: false, message: error.message }), { status: 500 });
    }
}
...
export async function DELETE(req) {
    try {
        ...
        return new Response(JSON.stringify({ success: true, message: 'Customer deleted successfully' }), { status: 200 });
    } catch (error) {
        return new Response(JSON.stringify({ success: false, message: error.message }), { status: 500 });
    }
}
