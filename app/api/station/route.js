...
export async function GET(req) {
    try {
        ...
        // Search criteria (case-insensitive match)
        ...
        // If limit=0, return ALL matched results (use carefully for performance!)
        const skip = (page - 1) * limit;
        const query = StationModel.find(searchCriteria)
            .sort({ name: 1 }); // Optional sorting (alphabetical)
        ...
        // Get slugs for matched station IDs
