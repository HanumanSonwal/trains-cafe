...
const initialStations = [
  { key: '1', name: 'Aligarh Junction', code: 'ALJN', location: 'Aligarh', address: 'Aligarh Junction, Aligarh, Uttar Pradesh, India', status: '1' },
  { key: '2', name: 'Prayagraj Chheoki', code: 'PCOI', location: 'Prayagraj', address: 'Naini Gaon, Naini, Chak Imam Ali, Uttar Pradesh 211008', status: '0' },
  { key: '3', name: 'Zawar', code: 'ZW', location: 'Zawar', address: '', status: '1' },
  { key: '4', name: 'Zarap', code: 'ZARP', location: 'Zarap', address: '', status: '0' },
  { key: '5', name: 'Zangalapalle', code: 'ZPL', location: 'Zangalapalle', address: '', status: '1' },
  { key: '6', name: 'Zampini', code: 'ZPI', location: 'Zampini', address: '', status: '1' },
  { key: '7', name: 'Zamania', code: 'ZNA', location: 'Zamania', address: '', status: '0' },
  { key: '8', name: 'Zahirabad', code: 'ZB', location: 'Zahirabad', address: '', status: '1' },
  { key: '9', name: 'Zafarabad Junction', code: 'ZBD', location: 'Zafarabad Junction', address: '', status: '1' },
  { key: '10', name: 'Yusufpur', code: 'YFP', location: 'Yusufpur', address: '', status: '0' },
  { key: '11', name: 'Yevat', code: 'YT', location: 'Yevat', address: '', status: '1' }
];
...
const StationManagement = () => {
  ...
  const handleStatusChange = (checked, key) => {
    setStations(stations.map(station => station.key === key ? { ...station, status: checked ? '1' : '0' } : station));
    setFilteredStations(filteredStations.map(station => station.key === key ? { ...station, status: checked ? '1' : '0' } : station));
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="flex space-x-2">
          <EditFilled style={{ color: "#D6872A", fontSize: "22px" }} onClick={() => handleEdit(record)} />
          <DeleteFilled style={{ color: "#6F4D27", fontSize: "22px" }} onClick={() => handleDelete(record.key)} />
        </div>
      ),
    },
  ];
