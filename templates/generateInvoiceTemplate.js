  ...
  <div class="invoice">
    ...
    <div class="flex-row">
      <div class="flex-col">
        ...
        <div><span class="info-label">Station ID:</span> ${orderData?.station}</div>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>1</td>
          <td>₹${orderData?.payment?.tax?.toFixed(2)}</td>
      ...
      <tfoot>
        ...
        <tr class="totals">
          <td colspan="4" class="right">Coupon Discount</td>
    ...
    <p><strong>Payment Method:</strong> ${orderData?.payment?.payment_method}</p>
